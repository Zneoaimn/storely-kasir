<nav x-data="{ open: false }" class="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-gray-100">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if(auth()->user()->role === 'user')
                    ...
                    <x-responsive-nav-link :href="route('user.faq')" :active="request()->routeIs('user.faq')">
                        FAQ
                    </x-responsive-nav-link>
                @endif
            </div>
